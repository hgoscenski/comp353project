...
INSERT INTO `employee` VALUES (5005,1,'John','Doe',45000,'1990-09-07','123456789','ACT',NULL),(5010,1,'Jane','Smith',30000,'1985-01-01','987654321','ACT',5005),(5015,1,'Adam','Johnson',35000,'1988-02-29','123654756','TRM',5005),(5020,2,'Jacob','Maxson',40000,'1980-03-30','324435322','ACT',5005);
...
CREATE TABLE `loginemployee` (
  ...
  `SaltedPassword` int(11) DEFAULT NULL,
  PRIMARY KEY (`EmployeeID`),
  CONSTRAINT `loginemployee_employee_EmployeeID_fk` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`)
...
CREATE TABLE `loginuser` (
  ...
  UNIQUE KEY `LoginUser_EmailAddress_uindex` (`EmailAddress`),
  UNIQUE KEY `LoginUser_SaltedPassword_uindex` (`SaltedPassword`),
  KEY `LoginUser_user_UserID_fk` (`UserID`),
  CONSTRAINT `LoginUser_user_UserID_fk` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment` VALUES (1,'Evan Brennan','1381 W. Western','Chicago','IL',60202,'USA','2245987574832957','04/21','392');
...
CREATE TABLE `user` (
  ...
  KEY `user_payment_PayID_fk` (`PayID`),
  CONSTRAINT `user_payment_PayID_fk` FOREIGN KEY (`PayID`) REFERENCES `payment` (`PayID`)
...
INSERT INTO `user` VALUES (301,NULL,'1381 W. Western','Chicago','IL',60202,'USA','2698675309','e.brennan@gmail.com','Evan','Brennan'),(302,NULL,'1738 E. Michigan','Chicago','IL',60203,'USA','3122694365','mallany.k@gmail.com','Kathy','Mallany');
...
-- Dump completed on 2017-04-06 10:44:11
